...
/*   Updated: 2024/06/04 13:50:15 by rbutzke          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				children(t_ast_n *cmd, t_mini *mini, t_ast *ast,
						t_var_exe *var);
void				parent(t_ast_n *cmd, t_mini *mini, t_var_exe *var);
void				subshell(t_ast_n *cmd, t_mini *mini, t_ast *ast,
						t_var_exe *var);
void				init_fork(t_ast_n *cmd, t_mini *mini, t_ast *ast,
						t_var_exe *var);
...
void				echo(t_ast_n *cmd, t_mini *mini, t_ast *ast,
						t_var_exe *var);
void				env(t_ast_n *cmd, t_mini *mini, t_ast *ast, t_var_exe *var);
void				my_exit(t_ast_n *cmd, t_mini *mini, t_ast *ast,
						t_var_exe *var);
void				export(t_ast_n *cmd, t_mini *mini, t_ast *ast,
						t_var_exe *var);
void				pwd(t_ast_n *cmd, t_mini *mini, t_ast *ast, t_var_exe *var);
void				unset(t_ast_n *cmd, t_mini *mini, t_ast *ast,
						t_var_exe *var);

void				ft_manager_fd_builtin(t_ast_n *cmd, t_mini *mini,
						t_ast *ast, t_var_exe *var);
void				ft_valid_command_builtin(t_ast_n *cmd, t_mini *mini,
						t_ast *ast, t_var_exe *var);
