...
/*   Updated: 2024/05/28 17:29:20 by tforster         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// static int	syntax_oprtr(t_parse *parse, char *str)
// {
// 	if (parse->prev && tkn_is_oprtr(parse->prev) && tkn_is_oprtr(parse))
// 		return (syntax_error(parse, str, BAD_OPRTR_SYNTAX));
// 	return (NO_ERROR);
// }
...
// {
// 	// printf("MISSING FILE ERROR!");
// 	if (parse->prev && tkn_is_rdrct(parse->prev) && tkn_is_oprtr(parse))
