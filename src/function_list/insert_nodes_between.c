...
static void	list_dest_size_one(t_lst *lst_dest, t_node *between_a, t_node *between_b, t_lst *lst_new);
static void	list_dest_size_two_more(t_lst *lst_dest, t_node *between_a, t_node *between_b, t_lst *lst_new);
...
int	ft_insert_lst_between_lst(t_lst *lst_dest, t_node *between_a, t_node *between_b, t_lst *lst_new)
{
	...
	if (lst_dest->size == 1)
	{
		list_dest_size_one(lst_dest, between_a, between_b, lst_new);
		return (0);
	}
	if (lst_dest->size >= 2)
	{
